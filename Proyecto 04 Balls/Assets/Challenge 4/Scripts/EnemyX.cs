...
public class EnemyX : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _playerControllerX = GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerControllerX>();
    ...
    void Update()
    {
        ...
        speed = _spawnManagerX.enemySpeed;
    }
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        {
            Destroy(gameObject);
            _playerControllerX.gameOver = true;
        }
    }
